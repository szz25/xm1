...
require('./js/dis/app');
angular.bootstrap(document.documentElement, ['app', 'bootstrapApp', 'mainC', 'appButton', 'uiRouter']);
},{"./js/dis/accordion":2,"./js/dis/app":3,"./js/dis/button":4,"./js/dis/main":5,"./js/dis/uiRouter":6}],2:[function(require,module,exports){
...
const app = angular.module('app', ['ui.bootstrap', 'ngAnimate'])
    .controller('sec', ['$scope', '$http', function($scope, $http) {
        $http({
